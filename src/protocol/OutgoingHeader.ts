...
public static ROOM_CONSTRUCTION_TOOL = 397;
public static ROOM_CONSTRUCTION_TOOL_HISTORY_ACTION = 399;
public static GET_OCCUPIED_TILES = 1687;
    ...
    /** Habblet wired keybind (ArrowUp=1 … Shift=8). */
    public static HIT_KEYBIND = 365;
    ...
    public static USER_FURNITURE = 3150;
    public static REQUESTFURNIINVENTORYWHENNOTINROOM = 3500;
